...
namespace CancerBigData.UI
{
    ...
    /// <remarks>
    /// ===================== MỤC LỤC FILE =====================
    /// [QUAN TRỌNG] RefreshHealthAsync() — poll GET /health mỗi 30s (Timer), đổi màu
    ///              trạng thái: xanh = API + model OK · vàng = API OK nhưng model chưa
    ///              nạp · đỏ = không kết nối được.
    /// Phần còn lại là layout:
    ///   BuildTabs()      — tạo 5 tab, mỗi tab nhét 1 UserControl (Dock = Fill)
    ///   BuildStatusBar() — StatusStrip 4 ô: API · model_run_id · dataset_version · disclaimer
    /// =========================================================
    /// </remarks>
